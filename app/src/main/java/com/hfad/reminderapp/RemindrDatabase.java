 ...
 * @author ozgeonec
 */
public class RemindrDatabase extends SQLiteOpenHelper {
    // Database Version
    ...
    private static final String KEY_TAG = "tag_type";

    public RemindrDatabase(Context context) {
    ...
    public int addReminder(Reminder reminder){
        ...
        values.put(KEY_REPEAT_NO , reminder.getRepeatNmbr());
        values.put(KEY_REPEAT_TYPE, reminder.getRepeatType());
        values.put(KEY_TAG, reminder.getTagType());
    ...
    public List<Reminder> getAllReminders(){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                reminder.setRepeatNmbr(cursor.getString(5));
                reminder.setRepeatType(cursor.getString(6));
                reminder.setTagType(cursor.getString(7));
